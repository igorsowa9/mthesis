...
[Zwt_p, Zwt_n, Zhvdc_p, Zhvdc_n] = convertersImpedanceModel(H);
Hf = H*f;
figure(1)
semilogx(Hf,mag2db(abs(Zwt_p))); hold on
semilogx(Hf,mag2db(abs(Zwt_n)), 'r'); 
hold off
return
...
figure(5)
semilogy(H,ZabsM1, 'b', 'LineWidth', 2);
return
