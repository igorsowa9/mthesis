...
for hh=1:length(H)
    ...
    Z7 = LCL_R1+s*LCL_L1;
    % Z = imp_parallel(Z6, Z7); (Z7 is open circuit)
    Z = Z6;
...
for hh = 1:length(H)
    ...
    Y = [y11    -y12    0       0       0       0       0       0   ;...
        -y12    y22     -y23    0       0       0       0       0   ;...
        0       -y23    y33     -y34    0       0       0       0   ;...
        0       0       -y34    y44     -y45    0       0       0   ;...
        0       0       0       -y45    y55     -y56    0       0   ;...
        0       0       0       0       -y56    y66     -y67    0   ;...
        0       0       0       0       0       -y67    y77     -y78;...
        0       0       0       0       0       0       -y78    y88 ];
